...
export const Editorial: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-paper pb-32 animate-fade-in">
      ...
      {/* Header Section with Earth Background */}
      <div className="w-full bg-earth pt-32 pb-20 px-4 border-b border-paper/10">
        <div className="max-w-3xl mx-auto text-center">
          {/* Reduced font size from text-6xl/7xl to text-3xl/5xl and added font-light for elegance */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-x-12 md:gap-y-20">
          {filteredArticles.length > 0 ? (
            ...
            <div className="col-span-full text-center py-20">
              <p className="font-serif text-2xl text-earth/50">Nenhum artigo encontrado nesta categoria.</p>
            </div>
          )}
        </div>
