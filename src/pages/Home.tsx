                  ...
                  <div className="p-8 flex gap-6 items-start">
                    ...
                    <div className="flex-1 flex flex-col">
                      <div className="flex justify-between items-center mb-3">
                        ...
                        {isExpanded ? (
                          <Minus
                            className="h-3 w-3 text-accent transition-colors"
                            strokeWidth={1}
                          />
                        ) : (
                          <Plus
                            className={`h-3 w-3 text-earth/60 transition-colors ${
                      ...
                      {/* Date */}
                      <span
                        className={`text-[9px] font-sans mt-3 block uppercase tracking-widest transition-colors
                           ${
                             isExpanded
                               ? "text-earth/80"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-earth/10 border-y border-earth/10">
            {[
              ...
              <Link
                to="/editorial"
                key={idx}
                className={`${cat.bg} ${cat.hoverBg} py-10 px-6 md:p-12 flex flex-col items-center justify-center text-center aspect-auto md:h-[500px] group cursor-pointer transition-colors duration-700`}
              >
                {/* Icon */}
                <cat.icon
                  strokeWidth={0.5}
                  className={`h-10 w-10 md:h-12 md:w-12 mb-6 md:mb-8 ${cat.textColor} ${cat.hoverText} transition-colors duration-500`}
                />

                <h3
                  className={`font-serif text-2xl md:text-3xl mb-4 md:mb-6 ${cat.textColor} ${cat.hoverText} transition-colors duration-500`}
                >
                  {cat.title}
                </h3>
                ...
                <p
                  className={`font-sans text-xs font-medium tracking-[0.1em] uppercase opacity-80 group-hover:opacity-100 transition-opacity duration-500 ${cat.textColor} ${cat.hoverText}`}
                >
                  {cat.desc}
                </p>
